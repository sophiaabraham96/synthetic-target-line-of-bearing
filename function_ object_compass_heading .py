...
# Overview
# ------------------------------------------------------------
# Function to identify person angel of bearing from an image. The
# person object is identified by highest object person confidence.
# Google states it is faster than Yolo
#
# Input
# -----------------------------------------------------------
# image = image location( test only with jpg format)
# aov = angle of view of camera
# coh = compass heading
#
# Output
# -----------------------------------------------------------
